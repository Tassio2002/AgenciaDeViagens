...
namespace KiViagemDB.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinoId,Valor,Pais,Cidade")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinoId,Valor,Pais,Cidade")] Destino destino)
        {
